# CLAUDE.md — API-Powered Widget (HO11)
...
## About this project
A small web widget that pulls live data from a free public API.
**Primary way to do it:** Claude.ai chat (build the widget) — **no API key needed.**
...
- It's the **API-Powered Widget** hands-on. Calls free PUBLIC data APIs (not the Anthropic API) — no Anthropic key.
