...
The easiest way to build one: open **Claude.ai**, open the sample folder you like (`samples/sample-01` … `sample-05`), copy that sample's **example prompt** into Claude, and it writes you a complete `index.html`. Save the file, double-click it, done. Each sample README has the full step-by-step.
